...
/**
 * ClearingSystemMemberIdentification is a utility or helper class for ISO 20022-related processing.
 */
public class ClearingSystemMemberIdentification {
    ...
    public String dumpAsText() {
        ...
        sb.append("ClearingSystemMemberIdentification properties:\n");
