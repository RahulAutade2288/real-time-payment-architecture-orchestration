...
public class Signup3 extends JFrame implements ActionListener{
    ...
    Signup3(String formno){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("realtimepaymentarchitectureorchestration/icons/logo.jpg"));
        ...
        c7.setBounds(700,550,600,20);
        add(c7);
        
        b1.setBounds(900,600,100,30);
        add(b1);
        
        b2.setBounds(1020,600,100,30);
        add(b2);
